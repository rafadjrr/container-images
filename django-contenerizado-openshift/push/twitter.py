...
def capturarRecientes(fuente,mon_num,mon_den):
...
def capturarSinParametros():
  ...
  for twit in reversed(json_response.get('data')):
    ...
    if str[0:3]=='AAA':
      ...
      control = db.buscaOne(idfuente, fuente, fecha, mon_den, mon_num)
      if control == 0:
        db.POST_no_return(dic)
        existe = False
        print('nuevo:',idfuente)
      else:
        print('\n ===== Ya existe el twitt ',idfuente,' ====== \n')
