...
ReporticoApp::setConfig('project_title',"reportes");
...
ReporticoApp::setConfig('safe_design_mode',false);
...
ReporticoApp::setConfig('db_type',"pdo_sqlsrv");
...
if (ReporticoApp::getConfig('db_type') == 'framework') {
                ...
                // Asignacion de datos de la conexion a la base de datos con uso de Variables de entorno
                ReporticoApp::setConfig('db_user', getenv('USR'));
                ReporticoApp::setConfig('db_password', getenv('PASSWD'));
                ReporticoApp::setConfig('db_host', getenv('HOST'));
                ReporticoApp::setConfig('db_database', getenv('DB') );
        }
...
ReporticoApp::setConfig('AutoPaginate', 'HTML+PDF');
